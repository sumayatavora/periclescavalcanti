                ...
                <td align='center' valign='top'>
                    <table width='694' border='0' align='center' cellpadding='0' cellspacing='0'>
                        <tbody>
                            <tr>
                                <td align='right'>
                                    <img src='img/logo_email.png' width='250' height='70' alt='Logomarca'>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
$mail->Host = "smtp.periclescavalcanti.com.br"; // Endereço do servidor SMTP (caso queira utilizar a autenticação, utilize o host smtp.seudomínio.com.br)

$mail->SMTPAuth = true; // Usar autenticação SMTP (obrigatório para smtp.seudomínio.com.br)

$mail->Username = 'contato@periclescavalcanti.com.br'; // Usuário do servidor SMTP (endereço de email)

$mail->Password = 'BalaDeBacuri4709$'; // Senha do servidor SMTP (senha do email usado)
...
$mail->From = "contato@periclescavalcanti.com.br"; // Seu e-mail

$mail->Sender = "contato@periclescavalcanti.com.br"; // Seu e-mail

$mail->FromName = "Péricles Cavalcanti"; // Seu nome
...
$mail->AddAddress('contato@periclescavalcanti.com.br', 'Péricles Cavalcanti');
